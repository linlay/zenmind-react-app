...
function EntryRow({ item, styles, theme }) {
  ...
  if (item.kind === 'tool') {
    ...
    return (
      <Animated.View style={[styles.toolRow, enterStyle]}>
        <View style={[styles.timelineDot, styles.timelineDotTool, { backgroundColor: theme.timelineDot }]} />
        <View style={styles.toolBody}>
          <View style={[styles.toolChip, { borderColor: toneStyle.borderColor, backgroundColor: toneStyle.bg }]}>
            <Text style={[styles.toolChipText, { color: toneStyle.color }]}>
              <Text style={styles.toolChipPrefix}>call:</Text>{' '}
              <Text style={styles.toolChipName}>_{item.label}_</Text>
            </Text>
          </View>
          {item.detail ? (
  ...
  return (
    <Animated.View style={[styles.assistantRow, enterStyle]}>
      <View style={[styles.timelineDot, styles.timelineDotMessage, { backgroundColor: theme.timelineDot }]} />
      <View
        style={[
